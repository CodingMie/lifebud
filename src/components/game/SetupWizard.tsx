      ...
      render: (
        <div className="w-full flex flex-col items-center">
          <input
            ...
            className="w-full max-w-sm p-3 bg-white/50 backdrop-blur-sm border border-slate-200 rounded-lg text-lg text-center font-mono focus:outline-none focus:ring-2 focus:ring-black/10 text-black"
